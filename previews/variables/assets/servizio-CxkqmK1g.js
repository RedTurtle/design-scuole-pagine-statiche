import"./elements-B2FcJuDc.js";/* empty css             */function o(e){return new DOMParser().parseFromString(e,"text/html").querySelector("template")}function r(e,i={}){const n=e.content.cloneNode(!0);for(const t of n.querySelectorAll("[data-tpl]")){const l=i[t.dataset.tpl];l!==void 0&&(t.textContent=l)}for(const t of n.querySelectorAll("[data-tpl-href]")){const l=i[t.dataset.tplHref];l!==void 0&&t.setAttribute("href",l)}return n}function c(e,i){const n=document.createDocumentFragment();for(const t of i)n.append(r(e,t));return n}const d=`<template>
