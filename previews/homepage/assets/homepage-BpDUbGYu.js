import"./elements-BvYYOFSp.js";import{f as a,r as n,a as c}from"./templates-_zCjRqNr.js";const d=`<template>
...
`,e={serviceSection:a(d),serviceCard:a(m),header:a(p)},o={titolo:"In evidenza",cards:[{titolo:"Open day nella sede centrale",descrizione:"",url:"#"},{titolo:"Spettacolo finale per il corso di teatro per le primarie",descrizione:"Questo è un testo breve che riassume il contenuto della pagina di destinazione in massimo tre o quattro righe, senza troncamento.",url:"#"},{titolo:"Orientamento per le classi di terza media",descrizione:"Questo è un testo breve che riassume il contenuto della pagina di destinazione in massimo tre o quattro righe, senza troncamento.",url:"#"}]},r={scuola:{nome:"Istituto comprensivo F. Hernandez",denominazione:"",citta:"Livorno"}},s=n(e.serviceSection,{titolo:o.titolo}),l=n(e.header,{nome:r.scuola.nome}),v=s.querySelector("[data-cards]"),h=l.querySelector("[school-name]"),u=c(e.serviceCard,o.cards),z=n(e.header,r.scuola);v.appendChild(u);h.appendChild(z);const i=document.getElementById("in-evidenza"),t=document.getElementById("main-header");i&&i.appendChild(s);t&&t.appendChild(l);
